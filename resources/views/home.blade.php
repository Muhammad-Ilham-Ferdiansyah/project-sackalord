...
@section('container')
    ...
    <section class="w-full md:w-2/3 flex flex-col items-center px-3">
        ...
        <article class="flex flex-col shadow my-4 rounded-xl overflow-hidden">
            ...
            <div class="bg-white flex flex-col justify-start p-6">
                ...
                <p href="#" class="text-sm pb-3">
                    By <a href="#" class="font-semibold hover:text-purple-700">David Grzyb</a>, Published on April
                    25th, 2020
                </p>
        ...
        <article class="flex flex-col shadow my-4 rounded-xl overflow-hidden">
            ...
            <div class="bg-white flex flex-col justify-start p-6">
                <a href="#" class="text-purple-700 text-sm font-bold uppercase pb-4">Automotive, Finance</a>
                <a href="#" class="text-3xl font-bold hover:text-gray-700 pb-4">Lorem Ipsum Dolor Sit Amet Dolor Sit
                    Amet</a>
                <p href="#" class="text-sm pb-3">
        ...
        <article class="flex flex-col shadow my-4 rounded-xl overflow-hidden">
            ...
            <div class="bg-white flex flex-col justify-start p-6">
                <a href="#" class="text-purple-700 text-sm font-bold uppercase pb-4">Sports</a>
                <a href="#" class="text-3xl font-bold hover:text-gray-700 pb-4">Lorem Ipsum Dolor Sit Amet Dolor Sit
                    Amet</a>
                <p href="#" class="text-sm pb-3">
    ...
    <aside class="w-full md:w-1/3 flex flex-col items-center px-3">
        ...
        <div class="w-full bg-white shadow flex flex-col my-4 p-6 rounded-xl">
            <p class="text-xl font-semibold pb-5">About Us</p>
            <p class="pb-2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas mattis est
                eu odio sagittis tristique. Vestibulum ut finibus leo. In hac habitasse platea dictumst.</p>
            <a href="#"
                class="w-full bg-purple-800 text-white font-bold text-sm uppercase rounded-xl hover:bg-purple-700 flex items-center justify-center px-2 py-3 mt-4">
                Get to know us
            </a>
        </div>

        <div class="w-full bg-white shadow rounded-xl flex flex-col my-4 p-6">
            ...
            <a href="#"
                class="w-full bg-purple-800 text-white font-bold text-sm uppercase rounded-xl hover:bg-purple-700 flex items-center justify-center px-2 py-3 mt-6">

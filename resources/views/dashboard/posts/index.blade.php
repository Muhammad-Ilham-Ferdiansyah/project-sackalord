                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <a href="javascript:void(0);" onclick="location.href='/dashboard/posts/create'"
                            class="btn bg-gradient-info mx-3 mt-3"><i class="fas fa-plus mr-2"></i>Create New
                            Post</a>
                        @if ($posts->count())
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle ">
                                                    <div class="d-flex justify-content-between mx-4 px-4">
                                                        ...
                                                        <a href="javascript:void(0);"
                                                            onclick="location.href='/dashboard/posts/{{ $post->slug }}/edit'"
                                                        ...
                                                        <form action="/dashboard/posts/{{ $post->slug }}" method="POST"
                                                            ...
                                                            <button
                                                                ...
                                                                data-toggle="tooltip" data-original-title="Hapus Post"
                                                                onclick="return confirm('Are you sure?')">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                    height="16" fill="currentColor"
                                                                    class="bi bi-trash fill-current" viewBox="0 0 16 16">
                                                                    <path
                        ...
                        @else
                            <div class="p-3 border-2 border-black text-black mx-3 rounded-xl" role="alert">
                                <i class="fas fa-folder-open mr-2"></i>
                                You Haven't Write a Post.
                            </div>
                        @endif
                    </div>
                </div>
